...
例如，[Qwen2.5-VL](https://github.com/PaddlePaddle/PaddleFleet/blob/develop/paddlefleet/transformers/qwen2_5_vl/processor.py)是一个视觉语言模型，它使用了[Qwen2-VL](https://github.com/PaddlePaddle/PaddleFleet/blob/develop/paddlefleet/transformers/qwen2_vl/image_processor.py) image processor 和[Qwen2](https://github.com/PaddlePaddle/PaddleFleet/blob/develop/paddlefleet/transformers/qwen2/tokenizer.py) tokenizer. `ProcessorMixin` 类将这两者封装在一起，为模型提供一个统一的处理接口。

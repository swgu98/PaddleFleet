...
For example, [Qwen2.5-VL](https://github.com/PaddlePaddle/PaddleFleet/blob/develop/paddlefleet/transformers/qwen2_5_vl/processor.py) is a vision-language model that uses the [Qwen2-VL](https://github.com/PaddlePaddle/PaddleFleet/blob/develop/paddlefleet/transformers/qwen2_vl/image_processor.py) image processor and the [Qwen2](https://github.com/PaddlePaddle/PaddleFleet/blob/develop/paddlefleet/transformers/qwen2/tokenizer.py) tokenizer. A `ProcessorMixin` class wraps both of these, providing a single class for the model.
...
from paddlefleet.transformers import AutoProcessor
from paddlefleet.transformers import process_vision_info  # Processing functions for QwenVL models

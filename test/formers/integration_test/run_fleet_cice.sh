...
config_ci_dir=$root_dir/PaddleFleet/test/formers/config/ci
fixtures_dir=$root_dir/PaddleFleet/test/formers/fixtures/dummy
...
run_training() {
  ...
  if [ $exit_code -ne 0 ]; then
    ...
    python "$root_dir/PaddleFleet/test/formers/check_log_for_exitcode.py" "./${log_file}" "$check_string"

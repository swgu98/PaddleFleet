...
class TestFlashmaskAttentionForward(unittest.TestCase):
    ...
    @patch("paddlefleet.nn.attention.flashmask_attention.sink_attention_forward")
    ...
    @patch("paddlefleet.nn.attention.flashmask_attention.flashmask_attention")
    @patch("paddlefleet.nn.attention.flashmask_attention.paddle.base.core.is_compiled_with_cuda", return_value=False)

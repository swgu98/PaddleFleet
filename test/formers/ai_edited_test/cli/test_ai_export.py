...
class TestCheckDownloadRepo(unittest.TestCase):
    ...
    def test_non_local_model_with_explicit_hub(self):
        ...
        with patch("paddlefleet.cli.export.export.check_repo", return_value="/cached/model") as mock_check:
    ...
    def test_non_local_model_with_env_download_source(self):
        ...
        with patch(
            "paddlefleet.cli.export.export.check_repo", return_value="/cached/model"
...
class TestRunExport(unittest.TestCase):
    ...
    def test_run_export_raises_when_no_checkpoint(self):
        ...
        with patch("paddlefleet.cli.export.export.read_args", return_value=args) as _, patch(
            "paddlefleet.cli.export.export.get_export_args"
        ) as mock_get_export, patch("paddlefleet.cli.export.export.paddle.set_device"), patch(
            "paddlefleet.cli.export.export.os.path.isdir", return_value=False
        ), patch(
            "paddlefleet.cli.export.export.os.path.isfile", return_value=False
        ):
    ...
    def test_run_export_raises_when_lora_false(self):
        ...
        with patch("paddlefleet.cli.export.export.read_args", return_value=args), patch(
            "paddlefleet.cli.export.export.get_export_args"
        ) as mock_get_export, patch("paddlefleet.cli.export.export.paddle.set_device"), patch(
            "paddlefleet.cli.export.export.os.path.isdir", return_value=True
        ), patch(
            "paddlefleet.cli.export.export.is_valid_model_dir", return_value=True
        ):
    ...
    def test_run_export_lora_merge_success(self):
        ...
        with patch("paddlefleet.cli.export.export.read_args", return_value=args), patch(
            ...
            "paddlefleet.cli.export.export.check_download_repo", return_value="/tmp/base"
        ), patch(
            "paddlefleet.cli.export.export.resolve_file_path", return_value="/tmp/base/model.safetensors"
        ), patch(
            "paddlefleet.cli.export.export.MergeConfig", return_value=mock_merge_config
        ) as mock_merge_config_cls, patch(
            "paddlefleet.cli.export.export.MergeModel", return_value=mock_mergekit
        ) as mock_merge_model_cls, patch(
            "paddlefleet.cli.export.export.logger"
        ):

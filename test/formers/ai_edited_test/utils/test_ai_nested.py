...
class TestNestedUtils(unittest.TestCase):
    ...
    def test_nested_reduce_tensor_scalar(self):
        from paddlefleet.utils.nested import nested_reduce_tensor
    ...
    def test_nested_reduce_tensor_dict(self):
        ...
        from paddlefleet.utils.nested import TensorHolder, nested_reduce_tensor
    ...
    def test_nested_empty_tensor(self):
        ...
        from paddlefleet.utils.nested import TensorHolder, nested_empty_tensor
    ...
    def test_nested_copy_dict(self):
        from paddlefleet.utils.nested import nested_copy
    ...
    def test_flatten_list(self):
        from paddlefleet.utils.nested import flatten_list
    ...
    def test_nested_copy_place_non_tensor(self):
        from paddlefleet.utils.nested import nested_copy_place

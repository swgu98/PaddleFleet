...
class TestTypeValidators(unittest.TestCase):
    ...
    def test_positive_any_number_none(self):
        from paddlefleet.utils.type_validators import positive_any_number
    ...
    def test_positive_int_none(self):
        from paddlefleet.utils.type_validators import positive_int
    ...
    def test_padding_validator_none(self):
        from paddlefleet.utils.type_validators import padding_validator
    ...
    def test_truncation_validator_none(self):
        from paddlefleet.utils.type_validators import truncation_validator
    ...
    def test_image_size_validator_none(self):
        from paddlefleet.utils.type_validators import image_size_validator
    ...
    def test_device_validator_none(self):
        from paddlefleet.utils.type_validators import device_validator
    ...
    def test_tensor_type_validator_none(self):
        from paddlefleet.utils.type_validators import tensor_type_validator
    ...
    def test_resampling_validator_none(self):
        from paddlefleet.utils.type_validators import resampling_validator

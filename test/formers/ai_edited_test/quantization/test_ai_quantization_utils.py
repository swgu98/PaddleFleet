...
class TestQuantizationUtils(unittest.TestCase):
    ...
    def test_convert_to_qlora_state_dict_import_error(self):
        ...
        with patch("paddlefleet.quantization.quantization_utils.qlora_weight_quantize", None):
    ...
    def test_convert_to_quantize_state_dict_unsupported_algo(self):
        ...
        with patch(
            "paddlefleet.quantization.quantization_utils.parse_weight_quantize_algo", return_value="unsupported_algo"
        ):
